...
class Users extends BaseController
{
    ...
    {
        $this->private_data['table_field'] = ['Last Name', 'First Name', 'Middle Name' , 'Designation'];
    }

    private function getUsers()
    {
        $this->private_data['query'] = $this->getTable('users')->join('usergroups', 'users.groupID = usergroups.groupID')->limit(25)->get()->getResult();
    }
