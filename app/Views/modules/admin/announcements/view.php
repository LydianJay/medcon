        ...
        <div class="card mb-4">
            ...
            <div class="card-footer border-top">
                <div class="d-flex flex-row justify-content-center">
                    <a href="<?php echo site_url('admin/announcements/add') ?>" class="me-2">
                        <i class="bi bi-plus-square-fill"></i>
                    </a>
                    <a href="<?php echo site_url('admin/announcements/add') ?>">
            ...
            <div class="card mb-5">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column px-1">
                        ...
                        <p class="fs-4 text-dark text-start border-top"><?php echo $app->title. ' - ' . $app->date; ?></p>
                ...
                <div class="card-footer">
                    <div class="d-flex flex-column px-1">
                        <p class="fs-4 text-dark text-justify"><?php echo $app->content; ?></p>
