    ...
    <div class="col mb-xl-0 mb-4">
        <div class="card mx-lg-10 px-lg-5">
            <div class="card-header my-0 py-0 border-bottom">
                ...
                <p class="h2 text-center mb-2 mt-5">Add Clinic Service</p>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="container-fluid d-flex flex-column justify-content-start">
                        ...
                        <form action="<?php echo site_url('admin/clinic/postadd'); ?>" enctype="multipart/form-data" method="post">
                            <div class="container px-lg-5 px-sm-0">
                                <label class="form-label my-0">Title</label>
                                <div class="input-group input-group-outline">
                                    <input type="text" class="form-control" placeholder="Medicine Request" name="title" required>
                                </div>
                            </div>
