        ...
        <div class="card mb-4">
            <div class="card-header p-3 pt-2">
                ...
                <div class="text-center pt-1">
                    <p class="h1 text-bold text-info text-center mt-4">Clinic Services</p>
                    <h4 class="mb-0 text-bold"><?php echo ($table != null) ? count($table) : '0';?></h4>
                </div>
            </div>
            <div class="card-footer border-top">
                <div class="d-flex flex-row justify-content-center">
                    <a href="<?php echo site_url('admin/clinic/add') ?>" class="me-2">
                        <i class="bi bi-plus-square-fill"></i>
                    </a>
                    <a href="<?php echo site_url('admin/clinic/add') ?>">
                        <p class="text-center my-0 ">Add Services</p>
                    </a>
                </div>
